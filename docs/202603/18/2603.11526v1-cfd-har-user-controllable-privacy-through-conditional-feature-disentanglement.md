...
tags: ["query:aiot"]
score: 7.0
evidence: 在穿戴式和移动设备上使用机器学习的HAR应用
tldr: 针对可穿戴设备人体活动识别（HAR）中敏感隐私泄露和标注样本有限的挑战，本文提出CFD-HAR技术。该方法利用条件特征解耦学习，在潜空间分离活动特征与敏感属性，实现用户可控的细粒度隐私过滤。研究对比了其与自编码器少样本学习在隐私保护、数据效率及边缘部署方面的表现，为构建兼顾隐私与鲁棒性的物联网智能系统提供了重要参考。
selection_source: fresh_fetch
motivation: 旨在解决人体活动识别中传感器数据包含敏感隐私信息以及标注样本匮乏的双重挑战。
method: 提出一种基于条件特征解耦的表示学习技术，通过在潜空间分离活动与敏感属性实现动态隐私过滤。
result: 实验表明CFD-HAR能提供显式且可调的隐私控制，而自编码器方法虽标签效率更高但缺乏内在隐私保障。
conclusion: 现有范式均无法完全满足下一代物联网需求，未来需研究集成隐私、少样本适应与鲁棒性的统一框架。
---
