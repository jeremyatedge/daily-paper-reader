...
tags: ["query:aiot"]
score: 8.0
evidence: 用于管理6G网络联邦学习的智能体AI
tldr: 本研究针对6G网络下用户定制化设备端学习的需求，提出了一种将代理式人工智能（Agentic AI）作为联邦学习（FL）控制平面智能层的新架构。该系统将FL视为学习与网络管理的结合任务，通过检索、规划、编码和评估等专业化代理，动态处理客户端选择、资源分配及自适应训练。利用闭环评估和记忆机制，系统能在复杂网络环境下持续优化决策，显著提升了联邦学习在6G环境中的性能与可靠性。
selection_source: fresh_fetch
motivation: 6G网络中分布式数据训练面临严峻的延迟、带宽和可靠性挑战，需要更智能的网络管理手段来应对复杂的无线环境。
method: 提出一种由多专业代理组成的Agentic AI系统，通过监控工具和优化算法将高层任务目标转化为网络感知的具体管理动作。
result: 案例研究证明，该系统能根据信噪比、带宽和设备能力等实时状况，有效执行资源调度和代码生成，实现高性能的联邦学习。
conclusion: Agentic AI作为6G联邦学习的控制层，能够实现学习任务与网络资源的协同优化，是未来智能网络演进的关键技术。
---

## 摘要
向用户定制化端侧学习的转变对无线系统提出了新要求：模型必须在多样化、分布式的环境下进行训练，同时满足严格的延迟、带宽和可靠性约束。为了解决这一问题，我们提出了一种代理式人工智能（Agentic AI）作为管理 6G 网络联邦学习（FL）的控制层，它能将高层任务目标转化为感知网络状况的行动。我们的系统并非简单地将联邦学习视为一种学习挑战，而是将其看作学习与网络管理的结合任务。一组专注于检索、规划、编码和评估的专业智能体利用监控工具和优化方法，来处理客户端选择、激励机制构建、调度、资源分配、自适应本地训练以及代码生成。闭环评估和记忆的使用使系统能够持续优化其决策，并兼顾不断变化的信噪比、带宽条件和设备能力。最后，我们的案例研究证明了代理式人工智能系统利用工具实现高性能的有效性。
